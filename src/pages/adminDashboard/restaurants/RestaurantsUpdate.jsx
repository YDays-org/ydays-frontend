...
const RestaurantsUpdate = () => {
  ...
  useEffect(() => {
    ...
    if (foundRestaurant) {
      ...
      setName(foundRestaurant.name);
      setDescription(foundRestaurant.description);
      setLocation(foundRestaurant.location);
      setPhone(foundRestaurant.phone);
      setOpenAt(foundRestaurant.openAt);
      setCloseAt(foundRestaurant.closeAt);
      setSpecialite(foundRestaurant.specialite);
      setImagePreview(foundRestaurant.img);
      ...
      foundRestaurant.workingDays.forEach(day => {
        daysState[day] = true;
      });
      ...
      if (foundRestaurant.menu && foundRestaurant.menu.length > 0) {
        setMenuItems(foundRestaurant.menu.map(item => ({
          name: item.name,
